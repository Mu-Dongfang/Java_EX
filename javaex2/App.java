...
public class App {
    public static void main(String[] args) {
         ...
         * static可以标记出不需要成员变量的方法,静态的方法无法存取非静态的变量,通常使用类名调用(类名.方法名())
         * static修饰的变量将被类的所有对象共享,通常使用类名调用(类名.对象名)
         * static final修饰的变量为常量,常量的名称一般为大写字母
         * 可以使用静态初始化程序来初始化static final变量
         * static{
         * x = 1;
         * }
         */
        ...
        z2.show();
        /*
         抽象方法:没有方法体的方法应定义为抽象方法,限定子类必须实现，没有方法体且以分号结束
